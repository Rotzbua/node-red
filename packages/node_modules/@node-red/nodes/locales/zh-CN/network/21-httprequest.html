...
<script type="text/x-red" data-help-name="http request">
    ...
    <h3>详细</h3>
    <p>在节点内配置后，URL属性可以包含<a href="https://mustache.github.io/mustache.5.html" target="_blank">mustache样式</a>标签。 这些标签允许使用传入消息的值来构造url。例如，如果url设置为<code>example.com/{{{{topic}}}</code>，它将自动插入<code>msg.topic</code>的值。使用{{{...}}}可以防止mustache转义/ &等字符。</p>
