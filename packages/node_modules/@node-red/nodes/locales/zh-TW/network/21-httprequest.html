...
<script type="text/x-red" data-help-name="http request">
    ...
    <h3>詳細</h3>
    <p>在節點內配置後，URL屬性可以包含<a href="https://mustache.github.io/mustache.5.html" target="_blank">mustache樣式</a>標簽。 這些標簽允許使用傳入消息的值來構造url。例如，如果url設置爲<code>example.com/{{{{topic}}}</code>，它將自動插入<code>msg.topic</code>的值。使用{{{...}}}可以防止mustache轉義/ &等字符。</p>
